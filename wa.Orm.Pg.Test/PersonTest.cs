...
namespace wa.Orm.Pg.Test
{
    ...
    public class PersonTest : IDisposable
    {
        ...
        public void Insert()
        {
            int id = db.Insert<int>("persons", data, "id");
        ...
        {
            int id = await db.InsertAsync<int>("persons", data, "id").ConfigureAwait(false);
        ...
        public void Upsert()
        {
            ...
            Person person = db.Query<Person>("SELECT * FROM persons WHERE id=@Id", data).FirstOrDefault();
        ...
        public async Task UpsertAsync()
        {
            ...
            Person person = (await db.QueryAsync<Person>("SELECT * FROM persons WHERE id=@Id", data).FirstOrDefaultAsync().ConfigureAwait(false));
        ...
        public void Update()
        {
            ...
            int affected = db.Update("persons", data, "id=@Id");

            Person updated = db.Query<Person>("SELECT * FROM persons WHERE id=@Id", data).FirstOrDefault();
        ...
        public async Task UpdateAsync()
        {
            ...
            int affected = await db.UpdateAsync("persons", data, "id=@Id").ConfigureAwait(false);

            Person updated = (await db.QueryAsync<Person>("SELECT * FROM persons WHERE id=@Id", data).FirstOrDefaultAsync().ConfigureAwait(false));
        ...
        public void Delete()
        {
            ...
            int affected = db.Delete("persons", "id=@id", data);
        ...
        public async Task DeleteAsync()
        {
            ...
            int affected = await db.DeleteAsync("persons", "id=@id", data).ConfigureAwait(false);
        ...
        public void QueryAssoc()
        {
            ...
            Assert.NotNull(person);
            Assert.Equal(data.Id, int.Parse(person["id"].ToString()));
        ...
        public void QueryArray()
        {
            ...
            Assert.NotNull(person);
            Assert.Equal(data.Id, int.Parse(person[0].ToString()));
